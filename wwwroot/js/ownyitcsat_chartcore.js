        ...
        ctx.onclick = function (evt) {
            ...
            if (activePoints[0]) {
                ...
                if (label === 'No Login Password') {
                    ...
                    $('#policy_mgmt').on('shown.bs.modal', function () {
                        document.getElementById('chgmgmt1').innerHTML = titlevalue;
                    });
                }
                ...
                if (label === 'Hardware') {
                    ...
                    $('#change_mgmt').on('shown.bs.modal', function () {
                        document.getElementById('chgmgmt').innerHTML = titlevalue;
                    });
                }
                if (label === 'Software') {
                    labelvalue = 12;
                ...
                if (label === 'Linked Equipment') {
                    ...
                    $('#pctitle').html(label);
                    //$('#pctitle').on('shown.bs.modal', function () {
                    //    document.getElementById('chgmgmt').innerHTML = titlevalue;
                    //});
                }
                ...
                if (label === 'Current Day') {
                    ...
                    $('#systemheader').html('0');
                    $('#1day_time_popup').on('shown.bs.modal', function () {
                        document.getElementById('systemtitle').innerHTML = "System Detail";
                    });
                }
